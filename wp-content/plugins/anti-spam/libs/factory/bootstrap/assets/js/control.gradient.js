( function( $ ){
    ...
    $.fn.factoryBootstrap432_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap432_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-432 .factory-gradient").factoryBootstrap432_gradientControl();
    });
