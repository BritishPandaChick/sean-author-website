...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap449.fontControl", {
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap449_fontControl", $.factoryBootstrap449.fontControl );
        $(".factory-bootstrap-449 .factory-font").factoryBootstrap449_fontControl({});
    });
