( function( $ ){
    ...
    $.fn.factoryBootstrap433_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap433_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-433 .factory-paddings-editor").factoryBootstrap433_paddingsEditor();
    });
