...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap442.fontControl", {
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap442_fontControl", $.factoryBootstrap442.fontControl );
        $(".factory-bootstrap-442 .factory-font").factoryBootstrap442_fontControl({});
    });
