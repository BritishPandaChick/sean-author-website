( function($) {
	...
	$.fn.factoryBootstrap449_dropdownControl = function(option) {
	...
	$.fn.factoryBootstrap449_dropdownControl.Constructor = DropdownControl;

	// AUTO CREATING
	// ================================

	$(function() {
		$(".factory-bootstrap-449 .factory-dropdown").factoryBootstrap449_dropdownControl();
	});
