...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap439.fontControl", {
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap439_fontControl", $.factoryBootstrap439.fontControl );
        $(".factory-bootstrap-439 .factory-font").factoryBootstrap439_fontControl({});
    });
