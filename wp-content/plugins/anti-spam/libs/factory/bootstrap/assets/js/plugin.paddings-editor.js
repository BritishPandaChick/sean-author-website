( function( $ ){
    ...
    $.fn.factoryBootstrap432_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap432_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-432 .factory-paddings-editor").factoryBootstrap432_paddingsEditor();
    });
