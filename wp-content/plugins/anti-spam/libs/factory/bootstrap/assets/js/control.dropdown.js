( function($) {
	...
	$.fn.factoryBootstrap454_dropdownControl = function(option) {
	...
	$.fn.factoryBootstrap454_dropdownControl.Constructor = DropdownControl;

	// AUTO CREATING
	// ================================

	$(function() {
		$(".factory-bootstrap-454 .factory-dropdown").factoryBootstrap454_dropdownControl();
	});
