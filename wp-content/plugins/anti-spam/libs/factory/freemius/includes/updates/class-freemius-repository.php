...
namespace WBCR\Factory_Freemius_126\Updates;

// Exit if accessed directly
use Exception;
use Wbcr_Factory439_Plugin;
use WBCR\Factory_439\Updates\Repository;
...
class Freemius_Repository extends Repository {
	...
	/**
	 * @var \WBCR\Factory_Freemius_126\Premium\Provider
	 */
	private $premium;
	...
	public function init() {
		if ( ! $this->premium instanceof \WBCR\Factory_Freemius_126\Premium\Provider ) {
