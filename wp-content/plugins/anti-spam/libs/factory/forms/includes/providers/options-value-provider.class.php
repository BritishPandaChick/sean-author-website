<?php
	...
	if( !class_exists('Wbcr_FactoryForms439_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms439_OptionsValueProvider implements Wbcr_IFactoryForms439_ValueProvider {
