	...
	GradientSelection.prototype = {    
		...
		this.g2d = canvas.getContext("2d");
            ...
            _createColorPicker: function() {
                ...
                this.$colorPicker.factoryBootstrap442_iris({
                    width: 217,
                ...
                self.$colorHex.on('change paste keyup', function(){
                    ...
                    self.$colorPicker.factoryBootstrap442_iris('color', self.$colorHex.val());
		...
		this.$el.append( this.$directionDropdown );  
            ...
            showColorPicker: function( point ) {
                ...
                this.$colorPicker.factoryBootstrap442_iris( 'show' );
                this.$colorPicker.factoryBootstrap442_iris( 'option', 'color', point.color );
