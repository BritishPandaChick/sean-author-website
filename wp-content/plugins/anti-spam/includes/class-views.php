...
class Views {
	 ...
	 * @param \Wbcr_FactoryClearfy223_PageBase $page
	 *
	 ...
	 *
	 */
	public function get_template( $template, $data = [], \Wbcr_FactoryClearfy223_PageBase $page = null ) {
	 ...
	 *
	 */
	public function print_template( $template, $data = [], \Wbcr_FactoryClearfy223_PageBase $page = null ) {
