( function( $ ){
    ...
    $.fn.factoryBootstrap432_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap432_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-432 .factory-integer").factoryBootstrap432_integerControl();
    });
