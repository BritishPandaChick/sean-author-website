( function( $ ){
    ...
    $.fn.factoryBootstrap433_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap433_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-433 .factory-integer").factoryBootstrap433_integerControl();
    });
