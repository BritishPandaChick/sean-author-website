( function( $ ){
    ...
    $.fn.factoryBootstrap454_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap454_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-454 .factory-paddings-editor").factoryBootstrap454_paddingsEditor();
    });
