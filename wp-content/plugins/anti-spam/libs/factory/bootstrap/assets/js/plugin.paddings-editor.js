( function( $ ){
    ...
    $.fn.factoryBootstrap449_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap449_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-449 .factory-paddings-editor").factoryBootstrap449_paddingsEditor();
    });
