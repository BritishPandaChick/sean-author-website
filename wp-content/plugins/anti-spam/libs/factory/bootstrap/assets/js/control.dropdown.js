( function($) {
	...
	$.fn.factoryBootstrap432_dropdownControl = function(option) {
	...
	$.fn.factoryBootstrap432_dropdownControl.Constructor = DropdownControl;

	// AUTO CREATING
	// ================================

	$(function() {
		$(".factory-bootstrap-432 .factory-dropdown").factoryBootstrap432_dropdownControl();
	});
