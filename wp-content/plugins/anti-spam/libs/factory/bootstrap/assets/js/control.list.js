( function( $ ){
    ...
    $.fn.factoryBootstrap432_listControl = function (option) {
    ...
    $.fn.factoryBootstrap432_listControl.Constructor = list;

    $(function(){
        $(".factory-bootstrap-432 .factory-list").factoryBootstrap432_listControl();
    });
