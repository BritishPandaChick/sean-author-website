( function( $ ){
    ...
    $.fn.factoryBootstrap439_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap439_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-439 .factory-paddings-editor").factoryBootstrap439_paddingsEditor();
    });
