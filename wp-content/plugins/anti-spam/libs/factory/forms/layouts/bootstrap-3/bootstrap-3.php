<?php
	...
	if( !class_exists('Wbcr_FactoryForms439_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms439_Bootstrap3FormLayout extends Wbcr_FactoryForms439_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms439_Control $control
			 */
