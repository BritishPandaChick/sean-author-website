( function( $ ){
    ...
    $.fn.factoryBootstrap454_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap454_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-454 .factory-gradient").factoryBootstrap454_gradientControl();
    });
