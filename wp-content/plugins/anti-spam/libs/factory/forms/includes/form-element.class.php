<?php
	...
	if( !class_exists('Wbcr_FactoryForms439_FormElement') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms439_FormElement {
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_FactoryForms439_HtmlAttributeBuilder
			 */
			 ...
			 * @param Wbcr_FactoryForms439_Form $form A parent form.
			 */
			public function __construct($options, $form)
			{
				...
				$this->html_builder = new Wbcr_FactoryForms439_HtmlAttributeBuilder();
