( function( $ ){
    ...
    $.fn.factoryBootstrap433_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap433_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-433 .factory-gradient").factoryBootstrap433_gradientControl();
    });
