( function( $ ){
    ...
    $.fn.factoryBootstrap442_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap442_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-442 .factory-paddings-editor").factoryBootstrap442_paddingsEditor();
    });
