<?php
	...
	if( !class_exists('Wbcr_FactoryForms439_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms439_TabHolder extends Wbcr_FactoryForms439_Holder {
			 ...
			 * @param FactoryForms439_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms439_HtmlAttributeBuilder();
