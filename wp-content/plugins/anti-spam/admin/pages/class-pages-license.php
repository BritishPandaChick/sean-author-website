 ...
 */
class License extends \Wbcr_FactoryClearfy223_LicensePage {
	 ...
	 * @since 6.5.2
	 *
	 * @see   \FactoryPages431_ImpressiveThemplate
	 */
	...
	public function render_learnmore_section()
	{
		...
		<?php else: ?>
			<p style="margin-top: 10px;">
				<?php printf(__('Can’t find your key? Go to <a href="%s" target="_blank" rel="noopener">this page</a> and login using the e-mail address associated with your purchase.', 'wbcr_factory_clearfy_223'), "https://users.freemius.com/") ?>
			</p>
			<p style="margin-top: 10px;">
				<?php printf(__('We use certain personal data, such as your email address. By activating the license, you confirm that you have read the <a href="https://titansitescanner.com/terms-of-use/">Terms of Service</a> and <a href="https://titansitescanner.com/privacy/">Privacy Policy (in accordance with GDPR)</a>', 'wbcr_factory_clearfy_223'), $this->plugin->get_support()->get_contacts_url(true, 'license_page')) ?>
			</p>
		<?php endif;
	}
