( function( $ ){
    ...
    $.fn.factoryBootstrap439_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap439_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-439 .factory-integer").factoryBootstrap439_integerControl();
    });
