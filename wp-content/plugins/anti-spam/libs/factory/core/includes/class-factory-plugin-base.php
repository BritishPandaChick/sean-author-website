...
class  Wbcr_Factory442_Base {
	...
	/**
	 * Экземпляр класса \WBCR\Factory_442\Entities\Support используется для получения информации
	 ...
	 *
	 * @var \WBCR\Factory_442\Entities\Support
	 */
	protected $support;

	/**
	 * Экземпляр класса \WBCR\Factory_442\Entities\Paths используется для получения информации о
	 * путях плагина. Часто используется для получения путей или ссылок на место хранения плагина
	 * или его входного файла.
	 *
	 * @var \WBCR\Factory_442\Entities\Paths
	 */
	protected $paths;
	...
	public function __construct( $plugin_file, $data ) {
		...
		$this->support = new \WBCR\Factory_442\Entities\Support( $this->support_details );
		$this->paths   = new \WBCR\Factory_442\Entities\Paths( $plugin_file );
	 ...
	 * См. Wbcr_Factory442_Base::has_premium
	 */
	 ...
	 *
	 * @return string Возвращает заголовок плагина. См. Wbcr_Factory442_Base::plugin_title
	 */
	 ...
	 *
	 * @return string Возвращает префикс плагина.См. Wbcr_Factory442_Base::prefix
	 */
	 ...
	 *
	 * @return string Возвращает имя плагина. См. Wbcr_Factory442_Base::plugin_name
	 */
	 ...
	 *
	 * @return string Возвращает версию плагина. См. Wbcr_Factory442_Base::plugin_version
	 */
	 ...
	 *                            Wbcr_Factory442_Base::plugin_data
	 *
	 * @return null
	 */
	...
	/**
	 * Предоставляет доступ к экземпляру класса \WBCR\Factory_442\Entities\Support.
	 *
	 * @return \WBCR\Factory_442\Entities\Support
	 */
	...
	/**
	 * Предоставляет доступ к экземпляру класса \WBCR\Factory_442\Entities\Paths.
	 *
	 * @return \WBCR\Factory_442\Entities\Paths
	 */
	 ...
	 *
	 * @return object Возвращает объект с сырыми данными плагина. См. Wbcr_Factory442_Base::plugin_data
	 */
