( function( $ ){
    ...
    $.fn.factoryBootstrap442_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap442_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-442 .factory-integer").factoryBootstrap442_integerControl();
    });
